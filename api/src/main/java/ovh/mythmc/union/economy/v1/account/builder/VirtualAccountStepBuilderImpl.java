...
final class VirtualAccountStepBuilderImpl extends AbstractAccountStepBuilder<VirtualAccount, String> {

    @Override
    public @NotNull Optional<VirtualAccount> build() {
        final var account = new VirtualAccount() {
